...
if __name__ == '__main__':
    ...
    result_file_0 = result_path + folders[4] + "/" + "None_K_2_w_p2p_LiverMatch" + ".npy"

    result_file_1 = result_path + folders[4] + "/" + "None_K_3_w_p2p_LiverMatch" + ".npy"

    result_file_2 = result_path + folders[4] + "/" + "None_K_4_w_p2p_LiverMatch" + ".npy"

    result_file_3 = result_path + folders[4] + "/" + "None_K_5_w_p2p_LiverMatch" + ".npy"

    result_file_4 = result_path + folders[4] + "/" + "None_K_6_w_p2p_LiverMatch" + ".npy"

    result_file_5 = result_path + folders[4] + "/" + "None_K_7_w_p2p_LiverMatch" + ".npy"

    result_file_6 = result_path + folders[4] + "/" + "None_K_8_w_p2p_LiverMatch" + ".npy"

    result_file_7 = result_path + folders[0] + "/" + "None004002" + ".npy"
    ...
    bins_vis = [0, 0.25, 0.35, 0.45, 0.55, 0.65, 0.75, 0.85, 1]
