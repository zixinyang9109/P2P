...
if __name__ == '__main__':
    ...
    result_file_0 = result_path + folders[
        4] + "/" + sigma + "_wo_p2p_LiverMatch.npy"

    result_file_1 = result_path + folders[
        4] + "/" + sigma + "_wo_p2p_Lepard.npy"

    result_file_2 = result_path + folders[2] + "/" + sigma + ".npy"

    result_file_3 = result_path + folders[3] + "/" + sigma + ".npy"

    result_file_4 = result_path + folders[4] + "/" + sigma + "_w_p2p_Lepard.npy"

    result_file_5 = result_path + folders[4] + "/" + sigma + "_w_p2p_LiverMatch.npy"
    ...
    ax.plot(center_vis, mean_vis_4, 'X-', label="Lepard + proposed P2P", markersize=SMALL_SIZE, color='red')
    ax.plot(center_vis, mean_vis_5, 'X-', label="LiverMatch + proposed P2P", markersize=SMALL_SIZE, color='blue')
